              ...
              <div class="border border-gray-300 dark:border-gray-700">
                <div class="relative bg-gray-200">
                  <a href="/products/{{ $product->slug }}" class="">
                    <img src="{{ (isset($product->images) && count($product->images)) ? url('storage', $product->images[0]) : asset('images/placeholder.png') }}" alt="{{ $product->name }}" class="object-cover w-full h-56 mx-auto ">
                  </a>
                </div>
                <div class="p-3 ">
                ...
                <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                    ...
                    </svg><span wire:loading.remove wire:target="addToCart({{ $product->id }})">Add to Cart</span><span wire:loading wire:target="addToCart({{ $product->id }})" class="ml-2">Adding....</span>
                  </a>
